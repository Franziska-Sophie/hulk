...
pub struct MapPanel {
    ...
    kick_target_position: EnabledLayer<layers::KickTargetPosition, Ground>,
}
...
impl<'a> Panel<'a> for MapPanel {
    ...
    fn new(context: PanelCreationContext) -> Self {
        ...
        let kick_target_position = EnabledLayer::new(context.robot.clone(), context.value, false);
    ...
    fn save(&self) -> Value {
        json!({
            ...
            "kick_target_position": self.kick_target_position.save(),
        })
    }
}
    ...
    fn ui(self, ui: &mut Ui) -> eframe::egui::Response {
        ui.horizontal(|ui| {
            ui.menu_button("Overlays", |ui| {
                ...
                self.kick_target_position.checkbox(ui);
            });
